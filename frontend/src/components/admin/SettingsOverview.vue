<template>
  <div>
    ...
    <div>
      <v-card class="pa-5 my-5">
        ...
        <v-container class="pa-0 pt-5">
          <v-btn class="mr-3" color="secondary" @click="exportDialog = true">
            <SvgIcon name="archive-box" inline />
            export database
          </v-btn>
          <v-btn class="mr-3" color="secondary" @click="importDialog = true">
            <SvgIcon name="archive-box-arrow-down" inline />
            import database
          </v-btn>
          <v-btn class="mr-3" color="warning" @click="resetDialog = true">
            <SvgIcon name="archive-box-x-mark" inline />
            reset database
          </v-btn>
        </v-container>
      </v-card>
    ...
    <v-dialog v-model="exportDialog" width="auto" height="auto">
...
import SettingsDatabaseExport from "@/components/admin/SettingsDatabaseExport.vue";
import SettingsDatabaseImport from "@/components/admin/SettingsDatabaseImport.vue";
import SettingsDatabaseReset from "@/components/admin/SettingsDatabaseReset.vue";
...
export default {
  ...
  components: {
    ...
    SettingsDatabaseImport,
    SettingsDatabaseReset,
  },
  data() {
    return {
