...
# @comment_api.route("/execution/<exercise_name>", methods=["GET"])
# @jwt_required()
...
# @comment_api.route("/execution-state", methods=["GET"])
# @jwt_required()
...
# @comment_api.route("/upload", methods=["POST"])
# @jwt_required(locations="headers")
# def upload_file():
